...
//
// Portable implementation of SHA-256 (see project TSDuck).
//
//----------------------------------------------------------------------------
...
void SHA256::compress(const uint8_t* buf)
{
    uint32_t S[8], W[64];
...
bool SHA256::add(const void* data, size_t size)
{
...
bool SHA256::getHash(void* hash, size_t bufsize, size_t* retsize)
{
